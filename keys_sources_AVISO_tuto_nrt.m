...
sshtype='nrt'; % adt or sla

% use to differenciate job
runname = '';

% set the paths
path_in=[pwd,'/Tuto/DATA/',source,'/',domain,'/'];
path_out=[pwd,'/Tuto/RESULT/',source,'/',domain,'/',config,postname,'/',runname,'/'];
...
nc_u=[path_in,'ssu_',sshtype,'_',domain,postname,'.nc'];
nc_v=[path_in,'ssv_',sshtype,'_',domain,postname,'.nc'];
