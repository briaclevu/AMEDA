...
% 2) nc_u with variable ssu(t,j,i), step(t)
% 3) nc_v with variable ssv(t,j,i), step(t)
% Optional input file if type_detection is 2 or 3
% 4) nc_ssh with variable ssh(t,j,i), step(t)
%
...
path_out=['/home/blevu/Resultats/AVISO/',domname,'/',sshname,name,'/'];
...
% revolution period (T) per day and time step in days (dps)
